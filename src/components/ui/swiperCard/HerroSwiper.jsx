    ...
    <div dir="rtl" className="my-6">
      <>
        <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
          <SwiperSlide>
            <div className="w-[1400px] sm:w-[328px] sm:h-[177px]  h-[700px]  flex gap-2  sm:justify-between  bg-gray-200 rounded-2xl px-8 sm:px-3">
              <div className="flex flex-col items-start justify-center ">
                ...
                <span className="font-logo font-bold text-[50px] sm:text-base sm:leading-6 text-[#212328] leading-[74px] max-w-[500px] my-6 sm:my-1">
                ...
                <button className="mt-6 sm:mt-3 font-logo font-bold text-lg sm:text-xs text-white px-6 sm:px-2 py-3 sm:py-1 bg-primary rounded-lg sm:rounded-[23px]">
                  أطلب الان
                </button>
              </div>
              <div className="w-[50%]">
