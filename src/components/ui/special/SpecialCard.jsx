...
function SpecialCard({ specialCardImage }) {
  return (
    <div className=" flex flex-col  shrink-0 rounded-md md:ml-4 bg-[#F6F6F6] pt-5 px-5 w-80 sm:w-[190px] h-96 sm:h-[230px]">
      ...
      <a className="text-[#3074F0] mt-2 sm:mt-1 font-medium text-base sm:text-sm font-fm underline">
        أطلب الأن
